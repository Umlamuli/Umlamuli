//-----------------------------------------------------------------------
// <copyright file="DotTraceDiagnoser.cs" company="Umlamuli">
...
internal sealed class DotTraceDiagnoser : IDiagnoser
{
    ...
    private readonly string _saveLocation = $"C:\\temp\\Umlamuli\\{DateTimeOffset.Now.UtcDateTime:yyyy-MM-dd-HH_mm_ss}.bench.dtp";
