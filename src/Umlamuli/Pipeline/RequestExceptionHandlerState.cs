//-----------------------------------------------------------------------
// <copyright file="RequestExceptionHandlerState.cs" company="Umlamuli">
...
public class RequestExceptionHandlerState<TResponse>
{
    ...
    /// <summary>
    ///     Call to indicate whether the current exception should be considered handled and the specified response should be
    ///     returned.
    /// </summary>
