//-----------------------------------------------------------------------
// <copyright file="StreamRequestHandlerWrapper.cs" company="Umlamuli">
    ...
    where TRequest : IStreamRequest<TResponse>
{
        ...
        [EnumeratorCancellation] CancellationToken cancellationToken)
    {
        ...
        await foreach (var item in items.WithCancellation(cancellationToken)) yield return item;
    }
        ...
        [EnumeratorCancellation] CancellationToken cancellationToken)
    {
        ...
        await foreach (var item in cancellable) yield return item;
    }
}