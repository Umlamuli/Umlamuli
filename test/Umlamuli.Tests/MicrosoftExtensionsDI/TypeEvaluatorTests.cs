//-----------------------------------------------------------------------
// <copyright file="TypeEvaluatorTests.cs" company="Umlamuli">
...
public class TypeEvaluatorTests
{
    ...
    public TypeEvaluatorTests()
    {
        ...
        _services.AddUmlamuli(cfg =>
        {
            cfg.RegisterServicesFromAssemblyContaining(typeof(Ping));
            cfg.TypeEvaluator = t => t.Namespace == "Umlamuli.Extensions.Microsoft.DependencyInjection.Tests.Included";
        });
